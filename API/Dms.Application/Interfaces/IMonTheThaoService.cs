...
namespace Dms.Application.Interfaces
{
    ...
    {
        Task<PagedResult<MonTheThaoDto>> GetPagedAsync(int pageIndex, int pageSize, string? keyword = null, int? danhMucId = null, bool? trangThai = null);
        Task<IEnumerable<MonTheThaoDto>> GetAllAsync(int? danhMucId = null);
