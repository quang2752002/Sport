        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repairs_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeriodDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    BreakDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    ExtraTimeDurationMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairBookings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TournamentSportId = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_TournamentSports_TournamentSportId",
                        column: x => x.TournamentSportId,
                        principalTable: "TournamentSports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelegationName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TournamentSportId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Teams_TournamentSports_TournamentSportId",
                        column: x => x.TournamentSportId,
                        principalTable: "TournamentSports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AthleteCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Athletes_TournamentSports_TournamentSportId",
                        column: x => x.TournamentSportId,
                        principalTable: "TournamentSports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_TournamentSports_TournamentSportId",
                        column: x => x.TournamentSportId,
                        principalTable: "TournamentSports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Athletes_TournamentSportId",
                table: "Athletes",
                column: "TournamentSportId");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_TournamentSportId",
                table: "Groups",
                column: "TournamentSportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_TournamentSportId",
                table: "Matches",
                column: "TournamentSportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_TournamentSportId",
                table: "Teams",
                column: "TournamentSportId");
